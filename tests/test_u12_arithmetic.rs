...
fn test_checked_add() {
    ...
    assert_eq!(
        u12![0].checked_add(U12::max_value()),
        Some(U12::max_value())
    );
    assert_eq!(
        U12::max_value().checked_add(u12![0]),
        Some(U12::max_value())
    );
...
fn test_saturating_add() {
    ...
    assert_eq!(
        U12::max_value().saturating_add(U12::max_value()),
        U12::max_value()
    );
}
...
fn test_overflowing_add() {
    ...
    assert_eq!(
        u12![0].overflowing_add(U12::max_value()),
        (U12::max_value(), false)
    );
    assert_eq!(
        U12::max_value().overflowing_add(u12![0]),
        (U12::max_value(), false)
    );
    assert_eq!(U12::max_value().overflowing_add(u12![1]), (u12![0], true));
    assert_eq!(U12::max_value().overflowing_add(u12![2]), (u12![1], true));
    assert_eq!(
        U12::max_value().overflowing_add(U12::max_value()),
        (u12![0xFFE], true)
    );
}
...
fn test_overflowing_sub() {
    ...
    assert_eq!(
        U12::max_value().overflowing_sub(u12![0]),
        (U12::max_value(), false)
    );
    assert_eq!(
        U12::max_value().overflowing_sub(u12![1]),
        (u12![0xFFE], false)
    );
    assert_eq!(
        U12::max_value().overflowing_sub(u12![2]),
        (u12![0xFFD], false)
    );
    assert_eq!(
        U12::max_value().overflowing_sub(U12::max_value()),
        (u12![0], false)
    );
}
...
fn test_overflowing_mul() {
    ...
    assert_eq!(
        u12![2].overflowing_mul(u12![2048]),
        (U12::min_value(), true)
    );
...
fn test_checked_div() {
    assert_eq!(
        U12::max_value().checked_div(U12::max_value()),
        Some(u12![1])
    );
...
fn test_overflowing_div() {
    assert_eq!(
        U12::max_value().overflowing_div(U12::max_value()),
        (u12![1], false)
    );
...
fn test_checked_rem() {
    assert_eq!(
        U12::max_value().checked_rem(U12::max_value()),
        Some(u12![0])
    );
